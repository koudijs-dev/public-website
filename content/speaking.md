...
I believe in working in the open. Git is the closest thing I have to a personal philosophy: everything is a file, history is preserved, anyone can look. That extends to how I present. My slides are [written in code](/posts/slides-as-code/), version-controlled and publicly available. You'll find the source linked with each talk below.
...
### De Kracht van GitOps, MongoDB Atlas en Kubernetes *(Dutch)*
...
A deep dive into using GitOps to drive the full lifecycle of MongoDB Atlas instances from Kubernetes: creation and deletion. We explored why this pattern is surprisingly powerful and where it breaks down with conventional tooling.
...
I'm actively developing **Reverse GitOps** as a formal concept, with an open-source implementation at [reversegitops.dev](https://reversegitops.dev). If you're looking for a speaker on GitOps patterns, Kubernetes operators, or platform engineering, I'd love to talk.
